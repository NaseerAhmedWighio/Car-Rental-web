                ...
                <main className="mx-5 md:mx-8 lg:mx-20">
                    ...
                    {showFilter && (
                        <motion.aside
                            ...
                            className="lg:hidden flex flex-col absolute right-[17px] md:right-[25px] top-[130px] bg-white w-auto z-50 p-[2px] border border-[#C3D4E9] border-opacity-40 rounded-lg shadow-lg items-end text-[#C3D4E9] text-lg py-4 gap-2 scale-90"
                        >
                            <Link href="../cart/">
                                <div className="flex items-center justify-center w-[44px] h-[44px] rounded-full ">
                                    <div className="relative">
