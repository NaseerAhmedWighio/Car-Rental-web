...
export default function Popular() {
    ...
    return (
        <>
           <main className="w-full h-auto bg-[#F6F7F9] py-2">
           <div className="mx-4 md:mx-10 lg:mx-20">
                    <h1 className="text-[16px] text-[#90A3BF] font-semibold px-4 py-6">Recomendation Car</h1>
                    <div className="place-content-between grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-10 lg:grid-cols-3 2xl:grid-cols-4 lg:gap-20 ">
                        {
