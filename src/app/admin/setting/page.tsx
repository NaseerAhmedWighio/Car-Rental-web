            ...
            <div className="flex">
                ...
                <div className="w-full px-4 sm:px-6 lg:px-10 py-4 sm:py-6 lg:py-8">
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h1 className="text-[#1A202C] text-[20px] sm:text-[24px] font-bold mb-4">Settings</h1>
                        <p className="text-[#90A3BF] text-[14px] sm:text-[16px]">Manage your account preferences and security.</p>
                    </div>
                </div>
            </div>
        </main>
